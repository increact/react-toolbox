  ...
  describe('#on mount', function () {
    describe('when \'active\' prop is not set', function () {
      it('sets \'active\' Menu prop correctly', function () {
        var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_IconMenu.IconMenu, null));
        expect(wrapper.find('Menu').props().active).toBe(false);
      });
    });
    describe('when \'active\' prop is set to false', function () {
      it('sets \'active\' Menu prop correctly', function () {
        var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_IconMenu.IconMenu, {
          active: false
        }));
        expect(wrapper.find('Menu').props().active).toBe(false);
      });
      it('sets \'active\' Menu prop correctly after IconButton click', function () {
        var wrapper = (0, _enzyme.mount)(_react.default.createElement(_IconMenu.IconMenu, {
          active: false
        }));
...
describe('MenuItem', function () {
  describe('#onClick', function () {
    it('passes to listener the event', function () {
      var onClick = jest.fn();
      var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_Menu.Menu, null, _react.default.createElement(_MenuItem.MenuItem, {
        key: "1",
        onClick: onClick
      })));
