...
exports.navDrawerFactory = exports["default"] = exports.NavDrawer = void 0;
...
var _excluded = ["active", "className", "clipped", "permanentAt", "pinned", "theme"];
...
var factory = function factory(Drawer) {
  var NavDrawer = function NavDrawer(_ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement(Drawer, (0, _extends2["default"])({}, rest, {
