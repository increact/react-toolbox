...
exports.listItemLayoutFactory = exports["default"] = exports.ListItemLayout = void 0;
...
var factory = function factory(Avatar, ListItemContent, ListItemActions) {
  var ListItemLayout = function ListItemLayout(props) {
    ...
    var leftActions = [props.leftIcon && /*#__PURE__*/_react["default"].createElement(_FontIcon.FontIcon, {
      value: props.leftIcon,
      key: "leftIcon"
    }), props.avatar && /*#__PURE__*/_react["default"].createElement(Avatar, {
      image: props.avatar,
      key: "avatar"
    })].concat((0, _toConsumableArray2["default"])(props.leftActions));
    var rightActions = [props.rightIcon && /*#__PURE__*/_react["default"].createElement(_FontIcon.FontIcon, {
    ...
    var content = props.itemContent || /*#__PURE__*/_react["default"].createElement(ListItemContent, {
      theme: props.theme,
    ...
    return /*#__PURE__*/_react["default"].createElement("span", {
      className: className
    }, !emptyActions(leftActions) > 0 && /*#__PURE__*/_react["default"].createElement(ListItemActions, {
      type: "left",
      theme: props.theme
    }, leftActions), content, !emptyActions(rightActions) > 0 && /*#__PURE__*/_react["default"].createElement(ListItemActions, {
      type: "right",
      theme: props.theme
    }, rightActions));
  };
