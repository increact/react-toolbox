...
exports.listItemActionsFactory = exports["default"] = exports.ListItemActions = void 0;
...
var factory = function factory(ListItemAction) {
  var ListItemActions = function ListItemActions(_ref) {
    ...
    var validChildren = _react["default"].Children.toArray(children).filter(function (c) {
      return /*#__PURE__*/_react["default"].isValidElement(c);
    });

    return /*#__PURE__*/_react["default"].createElement("span", {
      className: theme[type]
    }, validChildren.map(function (action, i) {
      return /*#__PURE__*/_react["default"].createElement(ListItemAction, {
        key: i,
        theme: theme,
        action: action
      }) // eslint-disable-line
