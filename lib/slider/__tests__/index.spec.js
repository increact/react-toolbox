...
describe('Slider', function () {
  describe('#positionToValue', function () {
    it('returns min when position is less than origin', function () {
      var instance = (0, _enzyme.shallow)(_react.default.createElement(_Slider.Slider, {
        min: -500,
        max: 500
      })).instance();
      instance.setState({
  ...
  describe('#knobOffset', function () {
    it('returns percentage offset of knob for slider with given min/max/value props', function () {
      var slider = (0, _enzyme.shallow)(_react.default.createElement(_Slider.Slider, {
        min: -500,
        max: 500,
        value: -250
      })).instance();
  ...
  describe('#render', function () {
    it('contains a linear progress bar with proper properties', function () {
      var wrapper = (0, _enzyme.mount)(_react.default.createElement(_Slider.Slider, {
        min: 100,
        max: 1000,
        value: 140
      }));
