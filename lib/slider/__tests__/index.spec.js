...
describe('Slider', function () {
  describe('#positionToValue', function () {
    it('returns min when position is less than origin', function () {
      var instance = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Slider.Slider, {
        min: -500,
        max: 500
      })).instance();
      instance.setState({
      ...
      expect(instance.positionToValue({
        x: 400
      })).toEqual(-500);
    });
  ...
  describe('#knobOffset', function () {
    it('returns percentage offset of knob for slider with given min/max/value props', function () {
      var slider = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Slider.Slider, {
        min: -500,
        max: 500,
        value: -250
      })).instance();
  ...
  describe('#handleKeyDown', function () {
    it('does not call addToValue if is disabled', function () {
      var slider = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Slider.Slider, {
        disabled: true
      })).instance();
  ...
  describe('#render', function () {
    it('contains a linear progress bar with proper properties', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Slider.Slider, {
        min: 100,
        max: 1000,
        value: 140
      }));
    ...
    it('contains the proper number of snaps when snapped', function () {
      ...
      expect(sliderNode.props().className).toContain(_themeModule["default"].ring);
      expect(sliderNode.props().className).toContain(_themeModule["default"].pinned);
    });
  });
  describe('#events', function () {
    it('sets pressed state when knob is clicked', function () {
      ...
      var knob = wrapper.childAt(0).childAt(0).childAt(0);
