...
var _excluded = ["centered", "className", "multiple", "passthrough", "spread", "theme"],
    _excluded2 = ["children", "disabled", "ripple", "onRippleEnded", "rippleCentered", "rippleClassName", "rippleMultiple", "rippleSpread", "theme"];
...
var rippleFactory = function rippleFactory() {
  ...
  var _defaults$options = _objectSpread(_objectSpread({}, defaults), options),
      ...
      props = (0, _objectWithoutProperties2["default"])(_defaults$options, _excluded);

  return function (ComposedComponent) {
    var RippledComponent = /*#__PURE__*/function (_Component) {
      (0, _inherits2["default"])(RippledComponent, _Component);

      var _super = _createSuper(RippledComponent);
      ...
      function RippledComponent() {
        ...
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "rippleNodes", {});
        (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "doRipple", function () {
      ...
      (0, _createClass2["default"])(RippledComponent, [{
         ...
         */
        function rippleShouldTrigger(isTouch) {
        ...
        value: function animateRipple(x, y, isTouch) {
          ...
          if (this.rippleShouldTrigger(isTouch)) {
            ...
            this.setState(function (state) {
              return {
                ripples: _objectSpread(_objectSpread({}, state.ripples), {}, (0, _defineProperty2["default"])({}, key, initialState))
              };
            }, function () {
              ...
              _this3.setState(function (state) {
                return {
                  ripples: _objectSpread(_objectSpread({}, state.ripples), {}, (0, _defineProperty2["default"])({}, key, Object.assign({}, state.ripples[key], runningState)))
                };
              });
            });
          }
        ...
        value: function createRippleDeactivateCallback(eventType, rippleKey) {
          ...
          return function endRipple() {
            ...
            self.setState({
              ripples: _objectSpread(_objectSpread({}, self.state.ripples), {}, (0, _defineProperty2["default"])({}, rippleKey, Object.assign({}, self.state.ripples[rippleKey], {
                active: false
              })))
            });
          };
        ...
        value: function render() {
          ...
          var finalProps = defaultPassthrough ? _objectSpread(_objectSpread({}, childProps), {}, {
            theme: theme,
            disabled: disabled
          }) : childProps;
          return !ripple ? /*#__PURE__*/_react["default"].createElement(ComposedComponent, finalProps, children) : /*#__PURE__*/_react["default"].createElement(ComposedComponent, finalProps, [children, childRipples]);
        }
      }]);
