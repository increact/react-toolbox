...
exports["default"] = exports.autocompleteFactory = exports.Autocomplete = void 0;
...
var _excluded = ["allowCreate", "error", "label", "source", "suggestionMatch", "query", "selectedPosition", "keepFocusOnChange", "showSuggestionsWhenValueIsSet", "showSelectedWhenNotInSource", "onQueryChange", "theme"];
...
var factory = function factory(Chip, Input) {
  var Autocomplete = /*#__PURE__*/function (_Component) {
    ...
    function Autocomplete() {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChange", function (values, event) {
        ...
        if (_this.props.keepFocusOnChange) {
          ...
          _this.setState({
            ...
            _reactDom["default"].findDOMNode((0, _assertThisInitialized2["default"])(_this)).querySelector('input').blur();
          });
        }
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleQueryBlur", function (event) {
        if (_this.state.focus) _this.setState({
          focus: false
        });
        if (_this.props.onBlur) _this.props.onBlur(event, _this.state.active);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "updateQuery", function (query, notify) {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleQueryChange", function (value) {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleQueryFocus", function (event) {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleQueryKeyDown", function (event) {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleQueryKeyUp", function (event) {
        if (event.which === 27) _reactDom["default"].findDOMNode((0, _assertThisInitialized2["default"])(_this)).querySelector('input').blur();
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleSuggestionHover", function (event) {
        _this.setState({
          active: event.target.id
        });
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "select", function (event, target) {
    ...
    (0, _createClass2["default"])(Autocomplete, [{
        ...
        if (this.props.multiple) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              if (this.matches(this.normalise(_value), query)) {
                suggest.set(_key2, _value);
              }
      ...
      value: function values() {
        ...
        var _iterator3 = _createForOfIteratorHelper(this.source()),
            _step3;
      ...
      value: function render() {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          className: className
        }, this.props.selectedPosition === 'above' ? this.renderSelected() : null, /*#__PURE__*/_react["default"].createElement(Input, (0, _extends2["default"])({}, other, {
