...
exports["default"] = exports.avatarFactory = exports.Avatar = void 0;
...
var _excluded = ["alt", "children", "className", "cover", "icon", "image", "theme", "title"];
...
var factory = function factory(FontIcon) {
  var Avatar = function Avatar(_ref) {
    ...
    }, other), children, cover && typeof image === 'string' && /*#__PURE__*/_react["default"].createElement("span", {
      "aria-label": alt,
      className: theme.image,
      style: {
        backgroundImage: "url(".concat(image, ")")
      }
    }), !cover && (typeof image === 'string' ? /*#__PURE__*/_react["default"].createElement("img", {
      alt: alt,
      className: theme.image,
      src: image,
      title: title
    }) : image), typeof icon === 'string' ? /*#__PURE__*/_react["default"].createElement(FontIcon, {
