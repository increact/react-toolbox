...
describe('ProgressBar', function () {
  describe('#calculateRatio', function () {
    it('calculates the right ratio', function () {
      var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_ProgressBar.ProgressBar, {
        min: 100,
        max: 300,
  ...
  describe('#render', function () {
    it('renders the value and buffer bars when it is linear', function () {
      var wrapper = (0, _enzyme.mount)(_react.default.createElement(_ProgressBar.ProgressBar, {
        theme: _themeModule.default
      }));
